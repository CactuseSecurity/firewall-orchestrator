...
```code
tim@deb10-test:/var/log/fworch$ curl --request POST --url http://127.0.0.1:8888/api/AuthenticationToken/GetTokenPairTokenPair/ --data '{"Username":"admin", "Password": "fworch.1"}'
