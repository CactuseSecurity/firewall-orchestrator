...
Aug 25 16:48:19 ubu2004test fworch.auth-server[403234]: FWO_Auth_Server::Ldap.cs: ValidateUser called for user uid=admin,ou=systemuser,ou=user,{{ auth_ldap_path }}
...
Aug 25 16:48:19 ubu2004test slapd[403175]: conn=1002 op=0 BIND dn="uid=admin,ou=systemuser,ou=user,{{ auth_ldap_path }}" method=128
Aug 25 16:48:19 ubu2004test slapd[403175]: conn=1002 op=0 BIND dn="uid=admin,ou=systemuser,ou=user,{{ auth_ldap_path }}" mech=SIMPLE ssf=0
