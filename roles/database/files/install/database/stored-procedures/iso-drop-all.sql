...
Drop table "client_user" Cascade;
...
Drop table "client_network" Cascade;
Drop table "client_object" Cascade;
Drop table "client" Cascade;
Drop table "client_project" Cascade;
Drop table "device" Cascade;
---
Drop table "client_username" Cascade;
...
DROP FUNCTION public.get_client_ip_filter(integer);
DROP FUNCTION public.get_client_list(refcursor);
DROP FUNCTION public.get_client_relevant_changes(integer, integer, integer, timestamp without time zone, timestamp without time zone);
DROP FUNCTION public.get_client_rule_list(refcursor, integer);
...
DROP FUNCTION public.get_negated_client_ip_filter(integer);
DROP FUNCTION public.get_next_import_id(integer, timestamp without time zone);
DROP FUNCTION public.get_obj_ids_for_client();
