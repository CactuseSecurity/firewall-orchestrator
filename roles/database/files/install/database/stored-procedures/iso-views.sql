-- $Id: iso-views.sql,v 1.1.2.6 2011-05-11 08:02:26 tim Exp $
-- $Source: /home/cvs/iso/package/install/database/Attic/iso-views.sql,v $
---------------------------------------------------------------------------------------------
-- object views
---------------------------------------------------------------------------------------------
...
GRANT SELECT ON TABLE view_import_status_table TO itsecorg;  -- /usr/share/itsecorg/install/bin/write_import_status_file.sh is run as itsecorg as it will also be invoked via cli
