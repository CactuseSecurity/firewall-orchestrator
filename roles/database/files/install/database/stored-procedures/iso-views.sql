...
GRANT SELECT ON TABLE view_import_status_table TO itsecorg;  -- {{fworch_home}}/bin/write_import_status_file.sh is run as itsecorg as it will also be invoked via cli
