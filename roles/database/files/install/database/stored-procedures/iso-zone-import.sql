...
-- RETURNS:   VOID
--
CREATE OR REPLACE FUNCTION import_zone_main (INTEGER, BOOLEAN) RETURNS VOID AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION import_zone_single(INTEGER,INTEGER,VARCHAR,INTEGER) RETURNS VOID AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION import_zone_mark_deleted(INTEGER,INTEGER) RETURNS VOID AS $$
DECLARE
