...
ALTER TABLE "changelog_owner" ADD CONSTRAINT changelog_owner_new_owner_id_rule_foreign_key FOREIGN KEY ("new_owner_id") REFERENCES "owner" ("id") ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE "changelog_owner" ADD CONSTRAINT changelog_owner_old_owner_id_rule_foreign_key FOREIGN KEY ("old_owner_id") REFERENCES "owner" ("id") ON UPDATE RESTRICT ON DELETE CASCADE;
