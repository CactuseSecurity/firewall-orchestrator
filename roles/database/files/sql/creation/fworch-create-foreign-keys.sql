...
ALTER TABLE request.element ADD CONSTRAINT request_element_proto_foreign_key FOREIGN KEY (proto) REFERENCES stm_ip_proto(ip_proto_id) ON UPDATE RESTRICT ON DELETE CASCADE;
