...
Alter table "device_tenant_map" add  foreign key ("dev_id") references "device" ("dev_id") on update restrict on delete cascade;
...
Alter table "isoadmin" add  foreign key ("tenant_id") references "tenant" ("tenant_id") on update restrict on delete cascade;
...
Alter table "changelog_object" add  foreign key ("import_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship69" on "changelog_service" ("import_admin");
Alter table "changelog_service" add  foreign key ("import_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship70" on "changelog_user" ("import_admin");
Alter table "changelog_user" add  foreign key ("import_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship71" on "changelog_rule" ("import_admin");
Alter table "changelog_rule" add  foreign key ("import_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship109" on "changelog_object" ("doku_admin");
Alter table "changelog_object" add  foreign key ("doku_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship110" on "changelog_service" ("doku_admin");
Alter table "changelog_service" add  foreign key ("doku_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship111" on "changelog_user" ("doku_admin");
Alter table "changelog_user" add  foreign key ("doku_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship112" on "changelog_rule" ("doku_admin");
Alter table "changelog_rule" add  foreign key ("doku_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship159" on "object" ("last_change_admin");
Alter table "object" add  foreign key ("last_change_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship161" on "rule" ("last_change_admin");
Alter table "rule" add  foreign key ("last_change_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship162" on "service" ("last_change_admin");
Alter table "service" add  foreign key ("last_change_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
Create index "IX_Relationship163" on "usr" ("last_change_admin");
Alter table "usr" add  foreign key ("last_change_admin") references "isoadmin" ("isoadmin_id") on update restrict on delete cascade;
...
Create index "IX_Relationship301" on "stm_report_typ" ("report_typ_name");
Alter table "report" add  foreign key ("report_typ_id") references "txt" ("id") on update restrict on delete cascade;
