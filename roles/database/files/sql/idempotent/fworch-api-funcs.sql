...
RETURNS SETOF rule AS $$
    ...
    BEGIN
        ...
        ELSE
            ...
            IF mgm_unfiltered_tenant_id IS NOT NULL AND mgm_unfiltered_tenant_id=t_id OR
				gw_unfiltered_tenant_id IS NOT NULL AND gw_unfiltered_tenant_id=t_id
			THEN
