...
INSERT INTO txt VALUES ('H2019', 'German',  'Empf&auml;nger-Email-Adressen f&uuml;r Benachrichtigungen: Eine Liste von E-Mail-Adressen, getrennt durch Komma (`,`), Semikolon (`;`) oder senkrechten Strich (`|`), an die die durch diesen Termin erzeugten Reports versendet werden. Default-Wert = "leer".');
INSERT INTO txt VALUES ('H2019', 'English', 'Recipient email addresses for notification emails: A list of email addresses separated by commas (`,`), semicolons (`;`), or vertical bars (`|`) to which the reports generated by this schedule will be sent. Default value = "empty".');
