...
<ul>
    ...
    <li>&Auml;nderungen an den Dokumentationsfeldern einer Regel (Name, Kommentar, Zusatzfelder) werden nun ebenfalls in der Regel-&Auml;nderungshistorie protokolliert, dort aber als nicht sicherheitsrelevant gekennzeichnet. Die &Auml;nderungsreports und der Z&auml;hler der sicherheitsrelevanten &Auml;nderungen in der Import&uuml;bersicht ber&uuml;cksichtigen weiterhin nur sicherheitsrelevante &Auml;nderungen.</li>
...
<ul>
    ...
    <li>Changes to the documentation fields of a rule (name, comment, custom fields) are now recorded in the rule change history as well, but flagged as not security-relevant. The change reports and the counter of security-relevant changes in the import overview still cover security-relevant changes only.</li>
