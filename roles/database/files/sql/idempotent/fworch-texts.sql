...
INSERT INTO txt VALUES ('H5650', 'German',  'Regelerkennungs-Optionen: Legt fest, wann implementierte Regeln als identisch zu den modellierten Verbindungen angesehen werden.
    ...
    Wenn der IP-Adressvergleich aktiv ist, werden importierte Identit&auml;tsobjekte wie Check Point Updatable Objects, Access Roles und Domain-Objekte nach Objekttyp und Name verglichen, da ihre IP-Felder keine stabile Objektidentit&auml;t tragen.
');
INSERT INTO txt VALUES ('H5650', 'English', 'Rule Recognition Options: Defines, when implemented rules are regarded as identical to the modelled connections.
    ...
    When IP address comparison is active, imported identity objects such as Check Point updatable objects, access roles and domain objects are compared by object type and name because their IP fields do not carry stable object identity.
');
