...
---------------------------------------------------------------------------------------------
-- views for ordering objects by name
---------------------------------------------------------------------------------------------

-- nwobj view

DROP MATERIALIZED VIEW IF EXISTS view_rule_nwobj_resolved_sorted;

CREATE MATERIALIZED VIEW view_rule_nwobj_resolved_sorted AS
	select r.rule_id, r.created, r.removed, o.* from rule_nwobj_resolved r join object o on (r.obj_id=o.obj_id) order by mgm_id, obj_name;

-- adding indexes for nwobj view
Create index IF NOT EXISTS idx_view_rule_nwobj_resolved_sorted_mgm_id on view_rule_nwobj_resolved_sorted (mgm_id);
Create index IF NOT EXISTS idx_view_rule_nwobj_resolved_sorted_rule_id on view_rule_nwobj_resolved_sorted (rule_id);
Create index IF NOT EXISTS idx_view_rule_nwobj_resolved_sorted_obj_id on view_rule_nwobj_resolved_sorted (obj_id);

-- svc view

DROP MATERIALIZED VIEW IF EXISTS view_rule_svc_resolved_sorted;

CREATE MATERIALIZED VIEW view_rule_svc_resolved_sorted AS
	select r.rule_id, r.created, r.removed, s.* from rule_svc_resolved r join service s on (r.svc_id=s.svc_id) order by mgm_id, svc_name;

-- adding indexes for svc view
Create index IF NOT EXISTS idx_view_rule_svc_resolved_sorted_mgm_id on view_rule_svc_resolved_sorted (mgm_id);
Create index IF NOT EXISTS idx_view_rule_svc_resolved_sorted_rule_id on view_rule_svc_resolved_sorted (rule_id);
Create index IF NOT EXISTS idx_view_rule_svc_resolved_sorted_obj_id on view_rule_svc_resolved_sorted (svc_id);
...
Create index IF NOT EXISTS idx_view_rule_user_resolved_sorted_rule_id on view_rule_user_resolved_sorted (rule_id);
Create index IF NOT EXISTS idx_view_rule_user_resolved_sorted_obj_id on view_rule_user_resolved_sorted (user_id);
