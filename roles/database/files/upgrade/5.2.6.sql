...
Alter table "rule_svc_resolved" ADD COLUMN IF NOT EXISTS "last_seen" BIGINT;
Alter table "rule_nwobj_resolved" ADD COLUMN IF NOT EXISTS "created" BIGINT;
Alter table "rule_nwobj_resolved" ADD COLUMN IF NOT EXISTS "last_seen" BIGINT;
Alter table "rule_user_resolved" ADD COLUMN IF NOT EXISTS "created" BIGINT;
Alter table "rule_user_resolved" ADD COLUMN IF NOT EXISTS "last_seen" BIGINT;

Alter table "rule_nwobj_resolved" DROP CONSTRAINT IF EXISTS fk_rule_nwobj_resolved_created;
Alter table "rule_nwobj_resolved" DROP CONSTRAINT IF EXISTS fk_rule_nwobj_resolved_last_seen;
Alter table "rule_svc_resolved" DROP CONSTRAINT IF EXISTS fk_rule_svcobj_resolved_created;
Alter table "rule_svc_resolved" DROP CONSTRAINT IF EXISTS fk_rule_svcobj_resolved_last_seen;
Alter table "rule_user_resolved" DROP CONSTRAINT IF EXISTS fk_rule_userobj_resolved_created;
Alter table "rule_user_resolved" DROP CONSTRAINT IF EXISTS fk_rule_userobj_resolved_last_seen;
...
UPDATE rule_nwobj_resolved SET last_seen=(select max(control_id) FROM import_control);
UPDATE rule_svc_resolved SET created=(select min(control_id) FROM import_control);
UPDATE rule_svc_resolved SET last_seen=(select max(control_id) FROM import_control);
UPDATE rule_user_resolved SET created=(select min(control_id) FROM import_control);
UPDATE rule_user_resolved SET last_seen=(select max(control_id) FROM import_control);

-- now adding not null constraing:
Alter TABLE "rule_nwobj_resolved" alter column created set NOT NULL;
Alter TABLE "rule_nwobj_resolved" alter column last_seen set NOT NULL;
Alter TABLE "rule_svc_resolved" alter column created set NOT NULL;
Alter TABLE "rule_svc_resolved" alter column last_seen set NOT NULL;
Alter TABLE "rule_user_resolved" alter column created set NOT NULL;
Alter TABLE "rule_user_resolved" alter column last_seen set NOT NULL;
