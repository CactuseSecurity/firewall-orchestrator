...
update stm_dev_typ set dev_typ_is_multi_mgmt = TRUE, dev_typ_name = 'fortiADOM'  WHERE dev_typ_name='FortiManager';

insert into stm_dev_typ (dev_typ_id,dev_typ_name,dev_typ_version,dev_typ_manufacturer,dev_typ_predef_svc) VALUES (13,'FortiManager','5ff','Fortinet','') ON CONFLICT DO NOTHING;
-- insert into stm_dev_typ (dev_typ_id,dev_typ_name,dev_typ_version,dev_typ_manufacturer,dev_typ_predef_svc) VALUES (12,'Check Point','MDS R8x','Check Point','') ON CONFLICT DO NOTHING;
