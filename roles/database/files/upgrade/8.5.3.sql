...
insert into config (config_key, config_value, config_user) VALUES ('ownerLdapGroupNames', 'cn=ModellerGroup_@@ExternalAppId@@,ou=group,dc=fworch,dc=internal', 0) ON CONFLICT DO NOTHING;
