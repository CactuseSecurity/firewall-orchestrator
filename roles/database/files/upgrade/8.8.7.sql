...
alter table "owner" add column if not exists last_certified Timestamp;
alter table "owner" add column if not exists last_certifier int;
alter table "owner" add column if not exists last_certifier_dn Varchar;
