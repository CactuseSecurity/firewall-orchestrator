...
DROP FUNCTION IF EXISTS public.import_zone_single (
    bigint,
    integer,
    varchar,
    bigint
...
DROP FUNCTION IF EXISTS public.import_nwobj_single (
    bigint,
    integer,
    bigint,
    boolean
...
DROP CONSTRAINT IF EXISTS object_obj_ip_is_host;

ALTER TABLE IF EXISTS public.object
DROP CONSTRAINT IF EXISTS object_obj_ip_end_is_host;

ALTER TABLE IF EXISTS public.owner_network
DROP CONSTRAINT IF EXISTS owner_network_ip_is_host;

ALTER TABLE IF EXISTS public.owner_network
DROP CONSTRAINT IF EXISTS owner_network_ip_end_is_host;
...
DROP FUNCTION IF EXISTS public.import_nwobj_refhandler_objgrp_add_group (
    bigint,
    varchar,
    varchar,
    integer,
...
DROP FUNCTION IF EXISTS public.import_nwobj_refhandler_objgrp_add_single_groupmember (
    varchar,
    bigint,
    integer,
    bigint
...
DROP FUNCTION IF EXISTS public.import_nwobj_refhandler_objgrp_flat_add_group (
    bigint,
    bigint,
    integer,
    bigint
...
DROP FUNCTION IF EXISTS public.import_svc_single (
    bigint,
    integer,
    bigint,
    integer,
...
DROP FUNCTION IF EXISTS public.import_svc_refhandler_svcgrp_add_group (
    bigint,
    varchar,
    varchar,
    integer,
...
DROP FUNCTION IF EXISTS public.import_svc_refhandler_svcgrp_add_single_groupmember (
    varchar,
    bigint,
    integer,
    bigint
...
DROP FUNCTION IF EXISTS public.import_svc_refhandler_svcgrp_flat_add_group (
    bigint,
    bigint,
    integer,
    bigint
...
DROP FUNCTION IF EXISTS public.import_usr_single (
    bigint,
    integer,
    bigint,
    boolean
...
DROP FUNCTION IF EXISTS public.import_usr_refhandler_usergrp_add_group (
    bigint,
    varchar,
    varchar,
    integer,
...
DROP FUNCTION IF EXISTS public.import_usr_refhandler_usergrp_add_single_groupmember (
    varchar,
    bigint,
    integer,
    bigint
...
DROP FUNCTION IF EXISTS public.import_usr_refhandler_usergrp_flat_add_group (
    bigint,
    bigint,
    integer,
    bigint
...
-- rules
DROP FUNCTION IF EXISTS public.import_rules_combined (
    int,
    int,
    bigint,
    varchar,
...
DROP FUNCTION IF EXISTS public.import_rules_access (
    int,
    int,
    bigint,
    varchar,
...
DROP FUNCTION IF EXISTS public.import_rules_xlate (
    int,
    int,
    bigint,
    varchar,
...
DROP FUNCTION IF EXISTS public.security_relevant_change (
    record,
    record,
    int,
    int,
...
DROP FUNCTION IF EXISTS public.insert_single_rule (
    bigint,
    integer,
    integer,
    bigint,
...
DROP FUNCTION IF EXISTS public.resolve_rule_list (
    bigint,
    varchar,
    varchar,
    integer,
...
DROP FUNCTION IF EXISTS public.f_add_single_rule_from_element (
    bigint,
    varchar,
    integer,
    bigint,
...
DROP FUNCTION IF EXISTS public.f_add_single_rule_to_element (
    bigint,
    varchar,
    integer,
    bigint,
...
DROP FUNCTION IF EXISTS public.f_add_single_rule_svc_element (
    bigint,
    varchar,
    integer,
    bigint
...
DROP FUNCTION IF EXISTS public.import_rule_resolved_nwobj (
    int,
    bigint,
    bigint,
    bigint,
...
DROP FUNCTION IF EXISTS public.import_rule_resolved_svc (
    int,
    bigint,
    bigint,
    bigint,
...
DROP FUNCTION IF EXISTS public.import_rule_resolved_usr (
    int,
    bigint,
    bigint,
    bigint,
...
ADD COLUMN IF NOT EXISTS owner_mapping_source_id bigint;
-- stm_ for source (ip_based, custom_field, name_field, manual) todo
...
-- add owner source
INSERT INTO
    stm_owner_mapping_source (
        owner_mapping_source_type_id,
        owner_mapping_source_type_name
    )
VALUES (1, 'ip_based'),
    (2, 'custom_field'),
    (3, 'name_field'),
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_rule_owner_removed_is_null_unique ON rule_owner (rule_id, owner_id)
WHERE
    removed IS NULL;

-- create fks
ALTER TABLE rule_owner
DROP CONSTRAINT IF EXISTS rule_owner_rule_foreign_key;

ALTER TABLE rule_owner
ADD CONSTRAINT rule_owner_rule_foreign_key FOREIGN KEY (rule_id) REFERENCES rule (rule_id) ON UPDATE RESTRICT ON DELETE CASCADE;

ALTER TABLE rule_owner
DROP CONSTRAINT IF EXISTS rule_owner_created_import_control_foreign_key;

ALTER TABLE rule_owner
ADD CONSTRAINT rule_owner_created_import_control_foreign_key FOREIGN KEY (created) REFERENCES import_control (control_id) ON UPDATE RESTRICT ON DELETE CASCADE;

ALTER TABLE rule_owner
DROP CONSTRAINT IF EXISTS rule_owner_removed_import_control_foreign_key;

ALTER TABLE rule_owner
ADD CONSTRAINT rule_owner_removed_import_control_foreign_key FOREIGN KEY (removed) REFERENCES import_control (control_id) ON UPDATE RESTRICT ON DELETE CASCADE;

ALTER TABLE rule_owner
DROP CONSTRAINT IF EXISTS rule_owner_owner_mapping_source_id_stm_owner_mapping_source_foreign_key;

ALTER TABLE rule_owner
ADD CONSTRAINT rule_owner_owner_mapping_source_id_stm_owner_mapping_source_foreign_key FOREIGN KEY (owner_mapping_source_id) REFERENCES stm_owner_mapping_source (owner_mapping_source_type_id) ON UPDATE RESTRICT ON DELETE CASCADE;
