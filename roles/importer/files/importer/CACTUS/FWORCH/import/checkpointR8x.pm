...
sub copy_config_from_mgm_to_iso {
	...
	$enrich_cmd = "$python_bin $enrich_config_bin -a $api_hostname -l '$rulebase_names' -u $api_user $api_port_setting $ssl_verify $domain_setting -c '$cfg_dir/$obj_file_base' -d $debug_level";
