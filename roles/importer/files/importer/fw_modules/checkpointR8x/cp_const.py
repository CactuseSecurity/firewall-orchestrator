...
local_api_obj_types = (
    local_nw_obj_table_names + local_svc_obj_table_names + ["time"]
...
api_obj_types = nw_obj_table_names + svc_obj_table_names + ["time"]  # all obj table names to look at during import
