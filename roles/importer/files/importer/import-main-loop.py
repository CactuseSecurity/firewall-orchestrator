            ...
            if not skipping:
                for mgm in all_managers_with_submanagers:
                    ...
                    try:
                        ...
                        skipping = True
                    if not skipping and mgm_details["deviceType"]["id"] in (9, 12, 17, 22, 23, 24):  # only handle CPR8x Manager, fortiManager, Cisco MgmCenter, Palo Panorama, Palo FW, FortiOS REST
