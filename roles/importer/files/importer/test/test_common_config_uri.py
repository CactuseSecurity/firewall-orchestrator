...
class TestCommonModuleSelection:
    ...
    def test_get_module_selects_importer_for_known_package(
        ...
        assert get_module(import_state) is selected_module

    def test_get_module_rejects_unknown_package(self, monkeypatch: pytest.MonkeyPatch, import_state: ImportState):
        def fake_get_module_package_name(_import_state: ImportState) -> str:
            return "unsupported"
