    ...
    public class RuleQueries : Queries
    {
        ...
        static RuleQueries()
        {
            try
            {
                ...
                // reuse later – Query: getRuleDetailsForReport = ruleDetailsForReportFragments + GetQueryText("rule/getRuleDetails.graphql");
                ...
                // reuse later – Query: getNatRuleDetailsForReport = natRuleDetailsForReportFragments + GetQueryText("rule/getNatRuleDetails.graphql");
