...
namespace FWO.Config.Api
{
    public class ConfigDbAccess
    {
        ...
        //public ConfigValueType GetOrDefault<ConfigValueType>(string key, ConfigValueType defaultValue)
        //{
        //    try
        //    {
        //        return Get<ConfigValueType>(key);
        //    }
        //    catch (Exception e)
        //    {
        //        Log.WriteWarning("Fetch Config", $"Config item with key \"{key}\" could not be fetched. Using default value.");
        //        return defaultValue;
        //    }
        //}
