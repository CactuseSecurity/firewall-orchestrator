    ...
    public class NormalizedTimeObject
    {
        ...
        public static NormalizedTimeObject FromTimeObject(TimeObject timeObject)
        {
            return new NormalizedTimeObject
            {
                ...
                StartTime = timeObject.StartTime.HasValue ? NormalizedConfig.FormatDatetimeZ(timeObject.StartTime.Value, convertToUtc: true) : null,
                EndTime = timeObject.EndTime.HasValue ? NormalizedConfig.FormatDatetimeZ(timeObject.EndTime.Value, convertToUtc: true) : null
            };
        }
    }
}
