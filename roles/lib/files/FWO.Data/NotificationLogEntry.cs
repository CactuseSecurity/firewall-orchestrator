...
namespace FWO.Data
{
    ...
    /// <summary>
    /// Shared data for notification log read and insert entries.
    /// </summary>
    public abstract class NotificationLogData
    {
    ...
    /// </summary>
    public class NotificationLogEntry : NotificationLogData
    {
    ...
    /// <summary>
    /// Notification log data sent to the insert mutation.
    /// </summary>
    public class NotificationLogInsertEntry : NotificationLogData
    {
    }
}
