    ...
    <body>
        ...
        public static ReportBase ConstructReport(ReportTemplate reportFilter, UserConfig userConfig)
        {
            ...
            return repType switch
            {
                ...
                ReportType.Changes => new ReportChanges(query, userConfig, repType, reportFilter.ReportParams.TimeFilter, reportFilter.IncludeObjectsInReportChanges),
                ReportType.ResolvedChanges => new ReportChanges(query, userConfig, repType, reportFilter.ReportParams.TimeFilter, false),
                ReportType.ResolvedChangesTech => new ReportChanges(query, userConfig, repType, reportFilter.ReportParams.TimeFilter, false),
