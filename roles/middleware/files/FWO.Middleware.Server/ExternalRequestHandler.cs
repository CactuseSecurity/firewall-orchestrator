...
// 		public ExternalRequestHandler(FwoOwner owner, UserConfig userConfig, System.Security.Claims.ClaimsPrincipal authUser, ApiConnection apiConnection)
// 		{
// 			Owner = owner;
...
// 			wfHandler = new (LogMessage, userConfig, authUser, apiConnection, WorkflowPhases.request);
// 		}
