...
namespace FWO.Middleware.Server
{
    public class JwtWriter
    {
        ...
        public string CreateJWTMiddlewareServer()
        {
            ...
            subject.AddClaim(new Claim("x-hasura-allowed-roles", JsonSerializer.Serialize(new string[] { /*"middleware-server"*/"admin" }), JsonClaimValueTypes.JsonArray));
            subject.AddClaim(new Claim("x-hasura-default-role", /*"middleware-server"*/"admin"));
