...
namespace FWO.Test
{
    internal class ModellingAppZoneHandlerTestApiCon : SimulatedApiConnection
    {
        ...
        static readonly NetworkObject Nwgroup1 = new() { Id = 1, Name = "AZ4711", Type = new() { Name = ObjectType.Group }, ObjectGroupFlats = [new() { Object = NwObj1 }, new() { Object = NwObj3 }] };
