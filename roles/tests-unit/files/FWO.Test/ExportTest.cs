...
namespace FWO.Test
{
    ...
    internal class ExportTest
    {
        ...
        public void RulesGenerateHtml()
        {
            ...
            var reportRules = ConstructReportRules(false, query, userConfig);
        ...
        public void UnusedRulesGenerateHtml()
        {
            ...
            {
                ReportData = ConstructRuleReportData(false)
            };
        ...
        private static ReportRules ConstructReportRules(bool resolved, DynGraphqlQuery query, UserConfig userConfig)
        {
            ...
            MockReportRules reportRules = new MockReportRules(query, userConfig, ReportType.Rules);
