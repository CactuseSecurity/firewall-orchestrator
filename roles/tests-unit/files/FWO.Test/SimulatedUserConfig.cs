...
namespace FWO.Test
{
    ...
    internal class SimulatedUserConfig : UserConfig
    {
        public static Dictionary<string, string> DummyTranslate = new()
        {
            ...
            {"criterion_ipv6_not_supported","IPv6 is currently not supported for this criterion"},
            {"assess_ip_null","Network objects in source or destination without IP"},
            {"assess_no_matching_zone","Network objects in source or destination without an assignable network zone"},
            ...
            {"existing_violation_hidden_by_filter_not_assessable", "Not assessable (existing violation hidden by filter setting)" },
            ...
            {"E9031","Not all notifications could be sent to App responsibles." },
            ...
            {"U9044","Notifications were sent to App responsibles." },
            ...
            {"bundle_request_tasks_by_type","Bundle request tasks by task type"},
            ...
            {"H5539","Bundle request tasks by task type: If enabled, the email contains all matching request tasks of the same task type. Automatic single delivery per task type is only applied in the Internal Work OnSet flow."},
            ...
            {"C9033","Allow splitting mixed group modify tasks into separate add and remove tasks. If disabled, mixed tasks keep their original order."},
            {"C9034","Sort create-request tasks by type. Mixed group modifications can be split into separate add and remove tasks when enabled."},
