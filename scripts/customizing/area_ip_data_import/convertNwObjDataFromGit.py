...
def generate_public_ipv4_networks_as_internet_area() -> list[dict[str, str]]:
    internet_subnets: list[str] = ['0.0.0.0/5', '8.0.0.0/7', '11.0.0.0/8', '12.0.0.0/6', '16.0.0.0/4', '32.0.0.0/3', '64.0.0.0/2',
                        ...
                        '224.0.0.0/3']
    internet_dicts: list[dict[str, str]] = []
    net: str
...
if __name__ == "__main__":
    ...
    # read config
    subnet_data_filename: str = ipam_git_repo_target_dir + '/' + read_custom_config(args.config, ['subnetData'], logger=logger)[0]
    ...
    try:
        ...
        if os.path.exists(ipam_git_repo_target_dir):
            ...
            repo_url: str = "https://" + ipam_git_user + ":" + urllib.parse.quote(ipam_git_password, safe='') + "@" + ipam_git_repo
