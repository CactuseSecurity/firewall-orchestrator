        ...
        if len(subnet)<maxColumn+1:
            ...
            if not subnet[nameColumn].startswith('RES'):
                ...
                if len(nameParts)>1:
                    ...
                    logger.warning("line " + str(line) + ": ignoring malformed network entry for net " + subnet[ipColumn] + ", subnetname: " + subnet[nameColumn])
                    continue
