...
parser.add_argument('-l', '--layer', metavar='policy_layer_name(s)', required=True, help='name of policy layer to create rules in')
parser.add_argument('-n', '--number_of_test_objs', metavar='number_of_objs_to_create', default=3, help='How many objects and rules to generate; default=3')
parser.add_argument('-d', '--delete_all_test_data', action="store_true", help='delete all test data (all objects and rules with name iso_test_*')
